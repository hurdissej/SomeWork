...
namespace SpreadSheetReader.Persistence
{
    public static class ExcelReader
    {
        ...
        public static void WriteToFile(IEnumerable<Promotion> promotions, string directory)
        {
            ...
            result.Add(new[] { "PromotionID", "Customer", "Province", "StartDate", "EndDate", "SkuCode", "Average Promoted Price", "Standard Deviation", "Minimum Number Of Stores Ran" ,"Maximum Number Of Stores Ran" , "PercentageOfStoresRan","Volume"});
            foreach (var promotion in promotions)
            {
                result.Add( new[]
                {
                    ...
                    promotion.MinimumNumberOfStores.ToString("N"),
                    promotion.MaximumNumberOfStores.ToString("N"),
